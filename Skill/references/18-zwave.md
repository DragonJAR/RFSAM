...
- **Modulación/rate**: (G)FSK a 3 rates: 9.6 kbps (R1 legacy), 40 (R2), 100 (R3). Z-Wave Long Range (US 912/920) adds potencia y star topology.
...
- **Kit**: Gqrx (RTL-SDR/HackRF tuned a 908.42/868.42). Triggrear device (abrir puerta) para hacerlo hablar.
