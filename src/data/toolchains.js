...
export const toolchains = {
  BLE: {
    ...
    layers: {
      ...
      SP: {
        note: 'Capture feasibility, not a separate toolset. BLE spreads 40 channels across 80 MHz (2.402–2.480 GHz) and hops every few ms. Your capture radio’s instantaneous bandwidth (see the radios at the Link layer) decides how much you see at once — even the widest SDR here (~61 MHz) can’t cover all 80 MHz in a single pass. RTL-SDR is out entirely: it stops near 1.766 GHz, below the 2.4 GHz band.',
      },
      PHY: {
      ...
      LL: {
        ...
        hardware: [
          ...
          { tool: 'bladerf-2-micro', role: 'SDR capture (wide)', why: 'Runs ice9 with ~56 MHz of bandwidth — most of the BLE band in one pass, far fewer retunes than a HackRF.', software: ['ice9-bluetooth-sniffer', 'wireshark'] },
