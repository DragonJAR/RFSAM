  ...
  "layers": {
    ...
    "LL": {
      ...
      "tools": [
        ...
        { "tool": "whad", "role": "LoRaWAN sniff (STM32WL)", "why": "WHAD's LoRaWAN domain runs on an STM32WLxx board (its stm32wlxx-firmware), pulling LoRa/LoRaWAN frames into PCAP/Scapy from the same framework used across BLE and 802.15.4 — a single-board capture path when you have an STM32WL radio rather than an SDR.", "caveat": "WHAD's LoRaWAN support is newer than its BLE/802.15.4 domains — verify coverage for your region and spreading factor.", "deps": ["stm32wlxx"] }
      ]
    },
    "CR": {
